...
from logic_utils import check_guess, update_score, reset_game, parse_guess, get_range_for_difficulty
...
#
#     if outcome == "Too High":
#         if attempt_number % 2 == 0:  # BUG: added points on even attempts
...
if "attempts" not in st.session_state:
    ...
    # the game starts with one attempt already in it, which affects the amount of guesses in the first game by giving you one less attempt.
